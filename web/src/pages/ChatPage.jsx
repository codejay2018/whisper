...
function ChatPage() {
  ...
  // scroll to bottom when chat or message changes
  useEffect(()=>{
    ...
    <div className='h-screen bg-base-100 text-base-content flex'>
      ...
      <div className='w-80 border-r border-base-300 flex flex-col bg-base-200'>
        ...
        <div className=' flex-1 overflow-y-auto'>
          ...
          { chats.length === 0 && !chatsLoading &&  <NoConversationUI/> }
...
function NoConversationUI(){
  return(
    <div className='flex flex-col items-center justify-center px-4 py-12 text-center'>
      <MessageSquareIcon className='w-10 h-10 text-amber-400 mb-3'/>
      <p className='text-base-content/70 text-sm'>No conversation yet</p>
...
function NoChatSelectedUI(){
  return (
    <div className=' flex-1 flex flex-col items-center justify-center text-center px-8'>
      <div className='w-20 h-20 bg-linear-to-br from-amber-500/20 to-orange-500/20  flex items-center justify-center mb-6 rounded-3xl'>
      ...
      >Select a conversation from the sidebar or start a new chat to begin messaging</p>
    </div>
  );
}
